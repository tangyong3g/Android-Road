...
/**
 * @Title:
 * @Description: 参考资料 How to Avoid ConcurrentModificationException when using an Iterator
 * <p/>
...
public class ConcurrentModificationExceptionActivity extends Activity implements OnClickListener {
    ...
    public void startRsAnimation(String rs) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofInt(new AttriAnimationXMLActivity.ViewWrap(mShowRsTx), "width", 0, width).setDuration(5000);
