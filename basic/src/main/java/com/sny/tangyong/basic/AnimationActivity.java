...
public class AnimationActivity extends Activity
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_start) {
            playAnimationOne();
        } else if (id == R.id.btn_animation_two) {
            playAnimationTwo();
        } else if (id == R.id.ly_animation) {
    ...
    private void playAnimationTwo() {
        ...
        ScaleAnimation scalAnimation = new ScaleAnimation(0.05f, 2.0f, 0.1f, 2.0f, ScaleAnimation.RELATIVE_TO_SELF,
    ...
    public void onAnimationEnd(android.view.animation.Animation animation) {
        ...
        if (mAnimation != null) {
            ...
            // (android.widget.RelativeLayout.LayoutParams)mAnimation.getLayoutParams();
