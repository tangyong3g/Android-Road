...
public class CylinderDragTestView extends GLViewGroup {
        ...
        for (int i = 0; i < mIconCount; ++i) {
            ...
            view.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(GLView v) {
                     ...
                     * start drag 做的事情有:
                     * 
                     * 1: 把 mDragistener 做为dragView的source,把v 做为DragView的view 2: 把dragListener
                     * 添加到dragView的listeners 集合中去 3: 回调drageStar函数
                     */
    ...
    protected void dispatchDraw(GLCanvas canvas) {
        ...
        mTransformation.clear().setRotateAxisAngle(-mScrollAngle, 0, 1, 0, mMesh.getCenterX(), mMesh.getCenterY(),
                mMesh.getCenterZ());
    ...
    class DragListener implements GLDragListener {
        ...
        @Override
        public boolean onDropFrom(GLDragView view, float x, float y, Ray ray, GLDragListener target,
                boolean isHandled) {
            return false;
        }
