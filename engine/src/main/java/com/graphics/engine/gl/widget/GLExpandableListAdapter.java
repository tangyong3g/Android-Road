...
public interface GLExpandableListAdapter {
     ...
     */
    GLView getGroupView(int groupPosition, boolean isExpanded, GLView convertView, GLViewGroup parent);
     ...
     */
    GLView getChildView(int groupPosition, int childPosition, boolean isLastChild,
                        GLView convertView, GLViewGroup parent);
