...
public final class Shared {
    ...
    public static int argb(float a, float r, float g, float b) {
		return Color.argb((int) (a * 255f), (int) (r * 255f), (int) (g * 255f), (int) (b * 255f));	// CHECKSTYLE IGNORE
    }
    ...
    public static int degreesToExifOrientation(float normalizedAngle) {
		...
		} else if (normalizedAngle == 90.0f) {			// CHECKSTYLE IGNORE
			return ExifInterface.ORIENTATION_ROTATE_90;
		} else if (normalizedAngle == 180.0f) {			// CHECKSTYLE IGNORE
			return ExifInterface.ORIENTATION_ROTATE_180;
		} else if (normalizedAngle == 270.0f) {			// CHECKSTYLE IGNORE
    ...
    public static float exifOrientationToDegrees(int exifOrientation) {
        if (exifOrientation == ExifInterface.ORIENTATION_ROTATE_90) {
            return 90;		// CHECKSTYLE IGNORE
        } else if (exifOrientation == ExifInterface.ORIENTATION_ROTATE_180) {
            return 180;		// CHECKSTYLE IGNORE
        } else if (exifOrientation == ExifInterface.ORIENTATION_ROTATE_270) {
            return 270;		// CHECKSTYLE IGNORE
        }
        return 0;
    }
}
