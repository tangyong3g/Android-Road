...
public class GLExpandableListView extends GLListView {
    ...
    private GLExpandableListConnector mConnector;
    
    /** Gives us Views through group+child positions */ 
    private GLExpandableListAdapter mAdapter;
    ...
    public GLExpandableListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GLExpandableListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

//        TypedArray a =
//            context.obtainStyledAttributes(attrs, R.styleable.ExpandableListView, defStyle,
//                    0);
//
//        mGroupIndicator = a
//                .getDrawable(R.styleable.ExpandableListView_groupIndicator);
//        mChildIndicator = a
//                .getDrawable(R.styleable.ExpandableListView_childIndicator);
//        mIndicatorLeft = a
//                .getDimensionPixelSize(R.styleable.ExpandableListView_indicatorLeft, 0);
//        mIndicatorRight = a
//                .getDimensionPixelSize(R.styleable.ExpandableListView_indicatorRight, 0);
//        if (mIndicatorRight == 0 && mGroupIndicator != null) {
//            mIndicatorRight = mIndicatorLeft + mGroupIndicator.getIntrinsicWidth();
//        }
//        mChildIndicatorLeft = a.getDimensionPixelSize(
//                R.styleable.ExpandableListView_childIndicatorLeft, CHILD_INDICATOR_INHERIT);
//        mChildIndicatorRight = a.getDimensionPixelSize(
//                R.styleable.ExpandableListView_childIndicatorRight, CHILD_INDICATOR_INHERIT);
//        mChildDivider = a.getDrawable(R.styleable.ExpandableListView_childDivider);
//        
//        a.recycle();
    }
    ...
    protected void dispatchDraw(GLCanvas canvas) {
        ...
        GLExpandableListConnector.PositionMetadata pos;
        GLView item;
        Drawable indicator;
        int t, b;
...
//                    indicator.draw(canvas);
     ...
     */
    private Drawable getIndicator(GLExpandableListConnector.PositionMetadata pos) {
        Drawable indicator;
    ...
    void drawDivider(GLCanvas canvas, Rect bounds, int childIndex) {
        ...
        if (flatListPosition >= 0) {
            ...
            GLExpandableListConnector.PositionMetadata pos = mConnector.getUnflattenedPos(adjustedPosition);
...
//                divider.draw(canvas);
     ...
     */
    public void setAdapter(GLExpandableListAdapter adapter) {
        // Set member variable
        mAdapter = adapter;
        
        if (adapter != null) {
            // Create the connector
            mConnector = new GLExpandableListConnector(adapter);
        } else {
            mConnector = null;
        }
    ...
    @Override
    public boolean performItemClick(GLView v, int position, long id) {
     ...
     */
    boolean handleItemClick(GLView v, int position, long id) {
        final GLExpandableListConnector.PositionMetadata posMetadata = mConnector.getUnflattenedPos(position);
    ...
    public boolean expandGroup(int groupPos, boolean animate) {
        GLExpandableListConnector.PositionMetadata pm = mConnector.getFlattenedPos(ExpandableListPosition.obtain(
    ...
    public interface OnGroupClickListener {
         ...
         */
        boolean onGroupClick(GLExpandableListView parent, GLView v, int groupPosition,
                             long id);
    }
    ...
    public interface OnChildClickListener {
         ...
         * @return True if the click was handled
         */
        boolean onChildClick(GLExpandableListView parent, GLView v, int groupPosition,
    ...
    public long getExpandableListPosition(int flatListPosition) {
        ...
        final int adjustedPosition = getFlatPositionForConnector(flatListPosition);
        GLExpandableListConnector.PositionMetadata pm = mConnector.getUnflattenedPos(adjustedPosition);
    ...
    public int getFlatListPosition(long packedPosition) {
        GLExpandableListConnector.PositionMetadata pm = mConnector.getFlattenedPos(ExpandableListPosition
    ...
    public void setSelectedGroup(int groupPosition) {
        ...
        GLExpandableListConnector.PositionMetadata pm = mConnector.getFlattenedPos(elGroupPos);
        elGroupPos.recycle();
    ...
    public boolean setSelectedChild(int groupPosition, int childPosition, boolean shouldExpandGroup) {
        ...
        GLExpandableListConnector.PositionMetadata flatChildPos = mConnector.getFlattenedPos(elChildPos);
    ...
    @Override
    ContextMenuInfo createContextMenuInfo(GLView view, int flatListPosition, long id) {
        if (isHeaderOrFooterPosition(flatListPosition)) {
    ...
    public static class ExpandableListContextMenuInfo implements ContextMenu.ContextMenuInfo {
        ...
        public ExpandableListContextMenuInfo(GLView targetView, long packedPosition, long id) {
