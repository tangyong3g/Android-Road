...
import com.graphics.engine.gl.util.Vector3f;
...
public class Transformation3D {
    ...
    private com.graphics.engine.gl.math3d.Matrix mMatrix3D;
...
//    	clear();
    ...
    public com.graphics.engine.gl.math3d.Matrix getMatrix3D() {
    	return mMatrix3D;
    }
