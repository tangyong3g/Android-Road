...
public class Matrix4f {
	...
	public static FloatBuffer gFBMatrix = IBufferFactory.newFloatBuffer(16);	// CHECKSTYLE IGNORE
...
//	}
	...
	public final void mul(float[] m) {
		// vars
		float m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33;
		// CHECKSTYLE IGNORE 4 LINES
		float   m1_00 = m[0], m1_01 = m[4], m1_02 = m[8], m1_03 = m[12], 
				m1_10 = m[1], m1_11 = m[5], m1_12 = m[9], m1_13 = m[13], 
				m1_20 = m[2], m1_21 = m[6], m1_22 = m[10], m1_23 = m[14], 
				m1_30 = m[3], m1_31 = m[7], m1_32 = m[11], m1_33 = m[15];
		
		m00 = this.m00 * m1_00 + this.m01 * m1_10 + this.m02 * m1_20
		+ this.m03 * m1_30;
		m01 = this.m00 * m1_01 + this.m01 * m1_11 + this.m02 * m1_21
		+ this.m03 * m1_31;
		m02 = this.m00 * m1_02 + this.m01 * m1_12 + this.m02 * m1_22
		+ this.m03 * m1_32;
		m03 = this.m00 * m1_03 + this.m01 * m1_13 + this.m02 * m1_23
		+ this.m03 * m1_33;
		
		m10 = this.m10 * m1_00 + this.m11 * m1_10 + this.m12 * m1_20
		+ this.m13 * m1_30;
		m11 = this.m10 * m1_01 + this.m11 * m1_11 + this.m12 * m1_21
		+ this.m13 * m1_31;
		m12 = this.m10 * m1_02 + this.m11 * m1_12 + this.m12 * m1_22
		+ this.m13 * m1_32;
		m13 = this.m10 * m1_03 + this.m11 * m1_13 + this.m12 * m1_23
		+ this.m13 * m1_33;
		
		m20 = this.m20 * m1_00 + this.m21 * m1_10 + this.m22 * m1_20
		+ this.m23 * m1_30;
		m21 = this.m20 * m1_01 + this.m21 * m1_11 + this.m22 * m1_21
		+ this.m23 * m1_31;
		m22 = this.m20 * m1_02 + this.m21 * m1_12 + this.m22 * m1_22
		+ this.m23 * m1_32;
		m23 = this.m20 * m1_03 + this.m21 * m1_13 + this.m22 * m1_23
		+ this.m23 * m1_33;
		
		m30 = this.m30 * m1_00 + this.m31 * m1_10 + this.m32 * m1_20
		+ this.m33 * m1_30;
		m31 = this.m30 * m1_01 + this.m31 * m1_11 + this.m32 * m1_21
		+ this.m33 * m1_31;
		m32 = this.m30 * m1_02 + this.m31 * m1_12 + this.m32 * m1_22
		+ this.m33 * m1_32;
		m33 = this.m30 * m1_03 + this.m31 * m1_13 + this.m32 * m1_23
		+ this.m33 * m1_33;
	...
	public static void gluPersective(float fovy, float aspect, float zNear,
		...
		float radians = (float) (fovy / 2 * Math.PI / 180);	// CHECKSTYLE IGNORE
		...
		out.m32 = -1;
		out.m23 = -2 * zNear * zFar / deltaZ;		// CHECKSTYLE IGNORE
		out.m33 = 0;
	}
    ...
    public void toShortString(StringBuilder sb) {
        sb.append(" matrix=");
        sb.append('[');
        sb.append(m00); sb.append(", "); sb.append(m01); sb.append(", ");
        sb.append(m02); sb.append(", "); sb.append(m03); sb.append("][");
        sb.append(m10); sb.append(", "); sb.append(m11); sb.append(", ");
        sb.append(m12); sb.append(", "); sb.append(m13); sb.append("][");
        sb.append(m20); sb.append(", "); sb.append(m21); sb.append(", ");
        sb.append(m22); sb.append(", "); sb.append(m23); sb.append(']');
        sb.append('}');
    }
