...
void Java_com_go_gl_util_NdkUtil_glDrawElements(JNIEnv * env, jclass cls,
...
void Java_com_go_gl_util_NdkUtil_saveScreenshotTGA(JNIEnv * env, jclass cls, jint x,
...
void Java_com_go_gl_util_NdkUtil_saveScreenshot(JNIEnv *env, jclass cls, jint x,
...
void Java_com_go_gl_util_NdkUtil_saveScreenshotBitmap
...
jboolean Java_com_go_gl_util_NdkUtil_convertToHSVInternal
...
jint Java_com_go_gl_util_NdkUtil_getLibVersionInternal
  (JNIEnv *, jclass) {
	return LIB_VERSION;
}

jint Java_com_go_gl_util_NdkUtil_saveBitmapInternal
...
void Java_com_go_gl_util_NdkUtil_releasePixelsInternal
...
jint Java_com_go_gl_util_NdkUtil_restorePixelsInternal
...
void Java_com_go_gl_util_NdkUtil_glTexImage2D
...
void Java_com_go_gl_util_NdkUtil_glTexSubImage2D
...
jint Java_com_go_gl_util_NdkUtil_getPixelInternal(
