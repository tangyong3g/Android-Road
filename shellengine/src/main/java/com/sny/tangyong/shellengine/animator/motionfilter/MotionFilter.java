...
import com.sny.tangyong.shellengine.ICleanup;
import com.sny.tangyong.shellengine.animation.Transformation3D;
import com.sny.tangyong.shellengine.animator.AnimatorSet;
 ...
 * <br>功能详细描述:
 * <p>
 * <br>可以设置给视图，让视图做动画，替代Animation类，见{ GLView#setMotionFilter(MotionFilter)}
 * 以及{ GLView#startMotionFilter(MotionFilter)}。
