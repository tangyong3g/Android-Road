...
public class Vector3 implements Serializable, Vector<Vector3> {
	...
	/**
	 * @deprecated Static temporary vector. Use with care! Use only when sure
	 *             other code will not also use this.
	 * @see #tmp()
	 **/
	...
	/**
	 * @deprecated NEVER EVER SAVE THIS REFERENCE! Do not use this unless you are
	 *             aware of the side-effects, e.g. other methods might call this
	 *             as well.
	 * 
	...
	/**
	 * @deprecated Use {@link #scl(float)} instead. Divides all components of
	...
	/**
	 * @deprecated Use {@link #scl(float, float, float)} instead. Divides this
	 *             vector by the given vector
	 */
	...
	/**
	 * @deprecated Use {@link #scl(Vector3)} instead. Divides this vector by the
	 *             given vector
	 */
