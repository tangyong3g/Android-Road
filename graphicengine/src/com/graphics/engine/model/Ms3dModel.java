...
import com.graphics.engine.graphics.TextureListener;
...
import com.graphics.engine.model.AssetsUtil.OpenAssetFileResult;
...
public class Ms3dModel implements TextureListener, GLClearable {
	 ...
	 * @param x (x, y, z, w) 为首尾两帧之间的旋转量的四元数{@link com.graphics.engine.math3d.Quaternion}，(0, 0, 0, 1) 表示没有旋转
	 */
