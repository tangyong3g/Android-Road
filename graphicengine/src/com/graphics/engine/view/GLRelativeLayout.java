...
public class GLRelativeLayout extends GLViewGroup {
    ...
    private SortedSet<GLView> mTopToBottomLeftToRightSet = null;
    
    private boolean mDirtyHierarchy;
    private GLView[] mSortedHorizontalChildren = new GLView[0];
    private GLView[] mSortedVerticalChildren = new GLView[0];
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, com_android_internal_R_styleable.RelativeLayout);
        mIgnoreGravity = a.getResourceId(com_android_internal_R_styleable.RelativeLayout_ignoreGravity, View.NO_ID);
        mGravity = a.getInt(com_android_internal_R_styleable.RelativeLayout_gravity, mGravity);
        a.recycle();
    }
...
//    @android.view.RemotableViewMethod
    ...
    private void sortChildren() {
		...
		if (mSortedVerticalChildren.length != count) {
			mSortedVerticalChildren = new GLView[count];
		}
		if (mSortedHorizontalChildren.length != count) {
			mSortedHorizontalChildren = new GLView[count];
		}
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        GLView[] views = mSortedHorizontalChildren;
        int count = views.length;
        for (int i = 0; i < count; i++) {
            GLView child = views[i];
    ...
    private void alignBaseline(GLView child, LayoutParams params) {
     ...
     */
    private void measureChild(GLView child, LayoutParams params, int myWidth, int myHeight) {
    ...
    private void measureChildHorizontal(GLView child, LayoutParams params, int myWidth, int myHeight) {
        int childWidthMeasureSpec = getChildMeasureSpec(params.mLeft,
                params.mRight, params.width,
                params.leftMargin, params.rightMargin,
                mPaddingLeft, mPaddingRight,
    ...
    private boolean positionChildHorizontal(GLView child, LayoutParams params, int myWidth,
            boolean wrapContent) {
    ...
    private boolean positionChildVertical(GLView child, LayoutParams params, int myHeight,
            boolean wrapContent) {
    ...
    private void applyHorizontalSizeRules(LayoutParams childParams, int myWidth) {
        ...
        GLRelativeLayout.LayoutParams anchorParams;
    ...
    private GLView getRelatedView(int[] rules, int relation) {
    ...
    private void centerHorizontal(GLView child, LayoutParams params, int myWidth) {
    ...
    private void centerVertical(GLView child, LayoutParams params, int myHeight) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            GLView child = getChildAt(i);
            if (child.getVisibility() != GONE) {
                GLRelativeLayout.LayoutParams st =
                        (GLRelativeLayout.LayoutParams) child.getLayoutParams();
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new GLRelativeLayout.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof GLRelativeLayout.LayoutParams;
    }
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (mTopToBottomLeftToRightSet == null) {
            mTopToBottomLeftToRightSet = new TreeSet<GLView>(new TopToBottomLeftToRightComparator());
        }
        ...
        for (GLView view : mTopToBottomLeftToRightSet) {
     ...
     */
     private class TopToBottomLeftToRightComparator implements Comparator<GLView> {
        public int compare(GLView first, GLView second) {
            // top - bottom
     ...
     public static class LayoutParams extends ViewGroup.MarginLayoutParams {
         ...
         public LayoutParams(Context c, AttributeSet attrs) {
             ...
             TypedArray a = c.obtainStyledAttributes(attrs,
                     com_android_internal_R_styleable.RelativeLayout_Layout);
             ...
             for (int i = 0; i < n; i++) {
                 ...
                 switch (attr) {
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignWithParentIfMissing:
                         alignWithParent = a.getBoolean(attr, false);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_toLeftOf:
                         rules[LEFT_OF] = a.getResourceId(attr, 0);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_toRightOf:
                         rules[RIGHT_OF] = a.getResourceId(attr, 0);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_above:
                         rules[ABOVE] = a.getResourceId(attr, 0);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_below:
                         rules[BELOW] = a.getResourceId(attr, 0);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignBaseline:
                         rules[ALIGN_BASELINE] = a.getResourceId(attr, 0);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignLeft:
                         rules[ALIGN_LEFT] = a.getResourceId(attr, 0);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignTop:
                         rules[ALIGN_TOP] = a.getResourceId(attr, 0);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignRight:
                         rules[ALIGN_RIGHT] = a.getResourceId(attr, 0);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignBottom:
                         rules[ALIGN_BOTTOM] = a.getResourceId(attr, 0);
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignParentLeft:
                         rules[ALIGN_PARENT_LEFT] = a.getBoolean(attr, false) ? TRUE : 0;
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignParentTop:
                         rules[ALIGN_PARENT_TOP] = a.getBoolean(attr, false) ? TRUE : 0;
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignParentRight:
                         rules[ALIGN_PARENT_RIGHT] = a.getBoolean(attr, false) ? TRUE : 0;
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_alignParentBottom:
                         rules[ALIGN_PARENT_BOTTOM] = a.getBoolean(attr, false) ? TRUE : 0;
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_centerInParent:
                         rules[CENTER_IN_PARENT] = a.getBoolean(attr, false) ? TRUE : 0;
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_centerHorizontal:
                         rules[CENTER_HORIZONTAL] = a.getBoolean(attr, false) ? TRUE : 0;
                         break;
                     case com_android_internal_R_styleable.RelativeLayout_Layout_layout_centerVertical:
...
//         }
    ...
    private static class DependencyGraph {	// CHECKSTYLE IGNORE
        /**
		...
		private static String getParentString(GLView view) {
			String str = "view hierarchy: " + view + " cleanup=" + view.mCleanUped;
			GLViewParent parent = view.getGLParent();
			while (parent != null) {
				str += "\n" + parent;
				parent = parent.getGLParent();
			}
			return str;
		}
        ...
        private LinkedList<Node> findRoots(int[] rulesFilter) {
            ...
            for (int i = 0; i < count; i++) {
				...
				if (node.view == null) {
					throw new NullPointerException("node.view == null " + getParentString(node.view));
				}
				layoutParams = (LayoutParams) node.view.getLayoutParams();
				if (layoutParams == null) {
					throw new NullPointerException("layoutParams == null " + getParentString(node.view));
				}
				try {
					rules = layoutParams.mRules;
					rulesCount = rulesFilter.length;
				} catch (Exception e) {
					NullPointerException e1 = new NullPointerException(getParentString(node.view));
					e1.initCause(e);
					throw e1;
				}
        ...
        static void printViewId(Resources resources, GLView view) {
        ...
        static class Node implements Poolable<Node> {
             ...
             */
            GLView view;		// CHECKSTYLE IGNORE

            /**
             * The list of dependents for this node; a dependent is a node
             * that needs this node to be processed first.
             */
            final HashSet<Node> dependents = new HashSet<Node>();				// CHECKSTYLE IGNORE

            /**
             * The list of dependencies for this node.
             */
            final SparseArray<Node> dependencies = new SparseArray<Node>();		// CHECKSTYLE IGNORE
            ...
            static Node acquire(GLView view) {
