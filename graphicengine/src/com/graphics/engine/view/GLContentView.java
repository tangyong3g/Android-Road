...
import com.graphics.engine.Timer;
import com.graphics.engine.animator.ValueAnimator;
import com.graphics.engine.animator.ValueAnimator.AnimationHandler;
...
import com.graphics.engine.graphics.GLError;
...
import com.graphics.engine.graphics.TextureManager;
import com.graphics.engine.graphics.TextureRecycler;
...
import com.graphics.engine.util.FpsCounter;
import com.graphics.engine.util.FrameTracker;
import com.graphics.engine.util.NdkUtil;
import com.graphics.engine.view.GLView.AttachInfo;
...
public class GLContentView extends GLSurfaceView implements GLViewParent {
	...
	public static com.graphics.engine.util.Log sLog = new com.graphics.engine.util.Log("ShellEngine");
...
//				mDisablePredraw = false;
	...
	Ray getTouchRayInWorld() {
		if (mTouchRayInvalidated) {
			...
			com.graphics.engine.math3d.Point p = GeometryPools.acquirePoint().set(cp[0], cp[1], cp[2]);
			com.graphics.engine.math3d.Point q = GeometryPools.acquirePoint().set(mTouchX, -mTouchY, 0);
			mTouchRay.set(p, q);
			mTouchRay.startCast();
