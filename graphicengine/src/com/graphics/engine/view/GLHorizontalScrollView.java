...
public class GLHorizontalScrollView extends GLFrameLayout {
    ...
    public GLHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initScrollView();
    }
     ...
     */
    private GLView findFocusableViewInMyBounds(final boolean leftFocus,
            final int left, GLView preferredFocusable) {
        /*
     ...
     *         be found
     */
    private GLView findFocusableViewInBounds(boolean leftFocus, int left, int right) {
    ...
    private boolean scrollAndFocus(int direction, int left, int right) {
        ...
        GLView newFocused = findFocusableViewInBounds(goLeft, left, right);
        if (newFocused == null) {
            newFocused = this;
        }
    ...
    protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
        ...
        if (rect.right > screenRight && rect.left > screenLeft) {
            ...
            if (rect.width() > width) {
                ...
                scrollXDelta += (rect.left - screenLeft);           //CHECKSTYLE IGNORE 
            } else {
                // get entire rect at right of screen
                scrollXDelta += (rect.right - screenRight);         //CHECKSTYLE IGNORE
            }
            ...
            if (rect.width() > width) {
                // screen size chunk
                scrollXDelta -= (screenRight - rect.right);       //CHECKSTYLE IGNORE
            } else {
                // entire rect at left
                scrollXDelta -= (screenLeft - rect.left);         //CHECKSTYLE IGNORE
            }
    ...
    public void fling(int velocityX) {
        if (getChildCount() > 0) {
            ...
            GLView newFocused = findFocusableViewInMyBounds(movingRight,
