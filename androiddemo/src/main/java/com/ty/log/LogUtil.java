/*
 * 文 件 名: LogUtil.java 版 权: 3G 描 述: <描述> 修 改 人: caoshilei 修改时间: 2013-10-14 跟踪单号: <跟踪单号> 修改单号: <修改单号>
 * 修改内容: <修改内容>
 */
package com.ty.log;
...
public final class LogUtil {
    /** 日志输出目录，位于sd卡目录下 */
    public static final String NEXT_LOG_DIR = android.os.Environment.getExternalStorageDirectory().getAbsolutePath()
            + File.separator + "androidBegin_Data/debug_log";
    /** 日志文件前缀 */
    ...
    /**
     * <br>
     * 功能简述:注销日志，注销后日志文件删除，并且不再产生日志 <br>
     * 功能详细描述: <br>
     * 注意:
     */
    ...
    /**
     * <br>
     * 功能简述:删除/sd卡/next_log/目录下appdrawer_log为前缀的日志文件 <br>
     * 功能详细描述: <br>
     * 注意:
     */
