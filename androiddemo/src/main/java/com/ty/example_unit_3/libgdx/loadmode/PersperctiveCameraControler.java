...
/**
 * 相机控制器，响应inputProcessor完成相应的变化。
 * 
 * @author tangyong
 * 
 */
public class PersperctiveCameraControler extends InputAdapter {
	...
	public PersperctiveCameraControler (PerspectiveCamera cam) {
		this.cam = cam;
	}
