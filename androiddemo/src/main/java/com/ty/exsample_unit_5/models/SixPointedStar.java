...
package com.ty.exsample_unit_5.models;
...
public class SixPointedStar {
	...
	public String mVertexShader; // 顶点着色器代码脚本
	public String mFragmentShader; // 片元着色器代码脚本
	...
	public SixPointedStar (Context mv, float r, float R, float z) {
	...
	public void initShader (Context mv) {
		// 加载顶点着色器的脚本内容
		mVertexShader = ShaderUtil.loadFromAssetsFile("data/unit5/translate/sixstar/vertex.sh", mv.getResources());
		// 加载片元着色器的脚本内容
		mFragmentShader = ShaderUtil.loadFromAssetsFile("data/unit5/translate/sixstar/frag.sh", mv.getResources());
		// 基于顶点着色器与片元着色器创建程序
